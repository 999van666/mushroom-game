...
class User(Base):
    ...
    basket_capacity: Mapped[float] = mapped_column(
        Float,
        default=10.0
    )
...
class UserUpgrade(Base):
    ...
    upgrade_type: Mapped[str] = mapped_column(
        String(30)
    )
...
class Mushroom(Base):
    ...
    min_weight: Mapped[int] = mapped_column(
        Integer
    )
    ...
    price_100g: Mapped[int] = mapped_column(
        Integer
    )
